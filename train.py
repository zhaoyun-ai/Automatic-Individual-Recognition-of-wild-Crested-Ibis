...
class AugmentationModule:
    ...
    def __init__(self, size, epoch_samples, log_mixup_exp=True, mixup_ratio=0.4):
        self.train_transform = nn.Sequential(
            ...
            Shift(sample_rate=44100, min_shift=-0.5, max_shift=0.5, p=0.5),
...
def main(audio_dir, config_path='config.yaml', d=None, epochs=None, resume=None) -> None:
    ...
    #model.load_weight('/home/sibo/桌面/1/byol-a-master/lightning_logs/version_15/checkpoints/epoch=68-step=6554.ckpt', device)
